...
public:
	...
	OSGB36(const double Phi,const double LambdaE);
	...
	static double meridional(const double p) { return ellipsoid.meridional(p,phi0)*OSGB36::bF0(); }
	static double n(const int i) { return pow(ellipsoid.N(),i); }
